#include <WiFi.h>
const char* ssid = "PLDTHOMEFIBR6yJ8z"; // Enter the SSID of your WiFi Network.
const char* password = "RASPBERRYsunripened2.4$";// Enter the Password of your WiFi Network.
...
byte sendEmail()
{
  ...
  */
  espClient.println("c21hcnRiaW4="); //base64, ASCII encoded Username
  if (!emailResp()) 
    return 0;
  //
  ...
  */
  espClient.println("UU1tZENzdndmRVY1aXRRSg==");//base64, ASCII encoded Password
  if (!emailResp()) 
    return 0;
  //
  Serial.println(F("Sending From"));
  // change to sender email address
  espClient.println(F("MAIL From: cscbot101@gmail.com"));
  if (!emailResp()) 
    return 0;
  // change to recipient address
  Serial.println(F("Sending To"));
  espClient.println(F("RCPT To: deleonjoshuachristian9@gmail.com"));
  if (!emailResp()) 
    return 0;
  //
  ...
  // change to recipient address
  espClient.println(F("To:  deleonjoshuachristian9@gmail.com"));
  // change to your address
  espClient.println(F("From: cscbot101@gmail.com"));
  espClient.println(F("Subject: ESP8266 test e-mail\r\n"));
  espClient.println(F("This is is a test e-mail sent from ESP32.\n"));
